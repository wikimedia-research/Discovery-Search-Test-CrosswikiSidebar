...
For the users who received the experimental user experience (UX), each additional wiki's top result was shown as a box in a sidebar with a link to view more results (see `r figure_caps("Example", display = "cite")`[^screenshot]). There were two groups of users who received the experimental UX and one control group that did not:

[^screenshot]: [Screenshot by Deb Tankersley](https://commons.wikimedia.org/wiki/File:Sister_project_search_results_test.jpg) available on [Wikimedia Commons](https://commons.wikimedia.org/wiki/Main_Page), licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.en).
...
As can be seen in `r figure_caps("Example", display = "cite")`, the cross-wiki results were displayed in black rather than the standard blue. This issue is tracked in [T158935](https://phabricator.wikimedia.org/T158935) and has been [resolved](https://gerrit.wikimedia.org/r/#/c/342200/) for the upcoming follow-up test ([T160004](https://phabricator.wikimedia.org/T160004)). We cannot estimate the effect this may have had on the results of the test, but we suspect this may have had a considerable negative effect because the results did not look like click-able links.
...
[^multimedia]: The multimedia reverse order bug is tracked in [T158937](https://phabricator.wikimedia.org/T158937) and was resolved in [Gerrit change 342200](https://gerrit.wikimedia.org/r/#/c/342200/).
