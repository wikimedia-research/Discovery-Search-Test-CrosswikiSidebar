% Author: Steven V. Miller (svmille@clemson.edu)
% Details: http://svmiller.com/blog/2016/02/svm-r-markdown-manuscript/
% Note: slightly modified from its original version (https://github.com/svmiller/svm-r-markdown-templates)
...
\usepackage{fontspec}
\setmainfont{ETBembo} % in general
\usepackage{pdflscape} % for landscape pages
\setsansfont{Gill Sans} % for captions
